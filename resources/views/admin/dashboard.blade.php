                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Performance Dashboard>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="ecommerce-widget">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header text-3xl"> Estimated Daily Revenue</h5>
                            <div class="card-body">
                                <div id="morris_totalrevenue"></div>
                            </div>
                            <div class="card-footer">
                                <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">Estimated Revenue Last 30 Days $26,000</span><span class="text-success float-right">+9.45%</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="table-responsive ">
                                    <table class="table ">
                                       ...
                                       <tr>
                                        ...
                                        <td><span class="badge-dot badge-success mr-1"></span>bar</td>

                                        @else
                                        <td><span class="badge-dot badge-brand mr-1"></span>booth</td>
                                        @endif
